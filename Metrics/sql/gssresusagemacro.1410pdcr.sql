replace macro systemfe.gss_resusage_td1410_pdcr
...
AS (
/* gss_resusage_td1410-R002 */
sel
'TD1410v1.72_pdcr' (named "Version")
...
,CODFactor / 10.0 (Named "PM_COD")
,Spare11 / 10.0 (Named "WM_COD")
,CASE when SpareInt > Spare01 then Spare01 ELSE SpareInt END (Named "IO_COD")
...
,sum(Spare00) (named "SPMAPhysPreReadKB")
...
,sum(Spare10) (named "VHCacheKB")
,max(Spare10) (named "MaxVHCacheKB")
...
,sum(Spare00) (named "VHAgedOut")
,sum(Spare01) (named "VHAgedOutKB")
,sum(Spare02) (named "VHAcqs")
,sum(Spare03) (named "VHAcqKB")
,sum(Spare04) (named "VHAcqReads")
,sum(Spare05) (named "VHAcqReadKB")
